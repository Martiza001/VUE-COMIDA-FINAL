<template>
  <div class="max-w-[800px] mx-auto p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 text-lg py-2">
      <div>
        <strong class="font-bold">Categoría:</strong> {{ meal.strCategory }}
      </div>
      <div>
        <strong class="font-bold">Área:</strong> {{ meal.strArea }}
      </div>
      <div>
        <strong class="font-bold">Etiqueta:</strong> {{ meal.strTags }}
      </div>
    </div>
